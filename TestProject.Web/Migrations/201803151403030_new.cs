namespace TestProject.Web.Migrations
{
    ...
    public partial class _new : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CijenaSPDVom = c.Single(nullable: false),
                        Korisnik = c.String(),
                        Primatelj = c.String(),
                    })
                ...
                c => new
                    {
                        ...
                        Faktura_FakturaID = c.Int(),
                    })
                .PrimaryKey(t => t.StavkaID)
                .ForeignKey("dbo.Faktura", t => t.Faktura_FakturaID)
                .Index(t => t.Faktura_FakturaID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Stavka", "Faktura_FakturaID", "dbo.Faktura");
            DropIndex("dbo.Stavka", new[] { "Faktura_FakturaID" });
